...
AS
SELECT [avaya].[CreatedMonthly],[lobs].[To] AS [Lob],[SkillSet],[Agent],[region].[To] AS Region,
	'Modern Workplace-Web Phone' AS [Channel],[Volume],[CreatedDaily],[CreatedWeekNo]
...
UNION 
SELECT [chat].[CreatedMonthly],[lobs].[To] AS [Lob],[SkillSet],[Agent],[region].[To] AS Region, 'Modern Workplace-Chat' AS [Channel], 
	1 AS [Volume],[CreatedDaily],[CreatedWeekNo], 
	[CreatedDaily]
